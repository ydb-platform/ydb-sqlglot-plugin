...
INSERT INTO `orders` (o_orderkey, o_custkey, o_orderstatus, o_totalprice, o_orderdate, o_orderpriority, o_clerk, o_shippriority, o_comment) VALUES
  (1, 1, 'F', 5000.00, Date('1993-07-15'), '1-URGENT',   'Clerk#000000001', 0, 'nag carefully '),
  (2, 2, 'O', 3000.00, Date('1994-06-15'), '2-HIGH',     'Clerk#000000002', 0, 'ular instructions'),
  (3, 1, 'F', 8000.00, Date('1993-10-20'), '3-MEDIUM',   'Clerk#000000003', 0, 'carefully regular fox'),
  (4, 3, 'O', 2000.00, Date('1995-01-15'), '1-URGENT',   'Clerk#000000004', 0, 'requests. regular deposits x-ray'),
  (5, 4, 'F', 6000.00, Date('1995-06-01'), '2-HIGH',     'Clerk#000000005', 0, 'regular foxes. ironic'),
  (6, 2, 'O', 1500.00, Date('1996-03-01'), '5-LOW',      'Clerk#000000006', 0, 'pending tithes'),
  (7, 3, 'O', 1000.00, Date('1994-08-01'), '3-MEDIUM',   'Clerk#000000007', 0, 'carefully final deposits');
...
INSERT INTO `lineitem` (l_orderkey, l_partkey, l_suppkey, l_linenumber, l_quantity, l_extendedprice, l_discount, l_tax, l_returnflag, l_linestatus, l_shipdate, l_commitdate, l_receiptdate, l_shipinstruct, l_shipmode, l_comment) VALUES
  (1, 2, 1, 1, 17.0, 2550.0, 0.04, 0.02, 'N', 'F', Date('1993-07-25'), Date('1993-07-20'), Date('1993-08-01'), 'DELIVER IN PERSON', 'MAIL',  'carefully pending'),
  (1, 5, 3, 2, 10.0,  900.0, 0.06, 0.02, 'N', 'F', Date('1994-01-10'), Date('1994-02-01'), Date('1994-02-15'), 'DELIVER IN PERSON', 'SHIP',  'blithely regular'),
  (2, 1, 2, 1,  5.0,  500.0, 0.06, 0.02, 'N', 'O', Date('1994-06-20'), Date('1994-07-01'), Date('1994-07-10'), 'DELIVER IN PERSON', 'AIR',   'pending instructions'),
  (3, 4, 3, 1, 20.0, 2400.0, 0.05, 0.02, 'R', 'F', Date('1993-10-25'), Date('1993-11-01'), Date('1993-11-15'), 'TAKE BACK RETURN',  'SHIP',  'ular requests'),
  (4, 1, 1, 1,  8.0,  800.0, 0.07, 0.02, 'N', 'O', Date('1995-03-20'), Date('1995-04-01'), Date('1995-04-15'), 'DELIVER IN PERSON', 'AIR',   'regular accounts'),
  (5, 1, 1, 1, 10.0, 1000.0, 0.05, 0.02, 'N', 'F', Date('1995-06-10'), Date('1995-07-01'), Date('1995-07-15'), 'DELIVER IN PERSON', 'AIR',   'furiously final'),
  (5, 3, 2, 2, 25.0, 3750.0, 0.08, 0.01, 'N', 'F', Date('1995-09-05'), Date('1995-10-01'), Date('1995-10-15'), 'TAKE BACK RETURN',  'AIR',   'carefully unusual'),
  (6, 1, 2, 1, 12.0, 1200.0, 0.06, 0.02, 'N', 'O', Date('1996-01-15'), Date('1996-02-01'), Date('1996-02-15'), 'DELIVER IN PERSON', 'AIR',   'blithely express'),
  (6, 5, 3, 2,  5.0,  450.0, 0.03, 0.02, 'N', 'O', Date('1994-01-20'), Date('1994-02-10'), Date('1994-02-20'), 'TAKE BACK RETURN',  'MAIL',  'pending deposits'),
  (7, 1, 5, 1,  6.0,  600.0, 0.06, 0.02, 'N', 'O', Date('1994-08-10'), Date('1994-09-01'), Date('1994-09-15'), 'DELIVER IN PERSON', 'AIR',   'ironic foxes'),
  (5, 3, 2, 3,  9.0, 1350.0, 0.05, 0.02, 'N', 'F', Date('1995-09-10'), Date('1995-10-01'), Date('1995-10-10'), 'DELIVER IN PERSON', 'AIR',   'carefully even');
